...
{this.p_updateSlideshow();this.p_addEvent(document,'onkeydown',this.p_keyDown.bind(this),true);this.p_addEvent(document,'onkeyup',this.p_keyUp.bind(this),true);this.div().getElementsByClassName("noselect").each(function(element)
...
{this.mCurrentMediaStream=imageStream;this.mThumbnailsInvalid=true;this.p_updateCanvasControls();var slideshowDiv=this.getElementById("slideshow_placeholder");var slideshowAnchor=this.getElementById("slideshow_anchor");if(this.mSlideshow!=null)
...
var options={backgroundColor:this.p_backgroundColor(),scaleMode:this.p_scaleMode(),advanceAnchor:slideshowAnchor};this.mSlideshow=new Slideshow(slideshowDiv,photos,this.p_onPhotoChange.bind(this),options);this.mSlideshow.setTransitionIndex(1);this.mSlideshow.pause();this.mSlideshow.showPhotoNumber(this.p_startIndex());if(this.preferences)
...
{var captionDiv=this.div().getElementsByClassName("Caption")[0];captionDiv.innerHTML="&#160;";captionDiv.id="caption";}}
