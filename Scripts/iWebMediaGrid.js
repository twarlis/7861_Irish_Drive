...
this.reflection.style.left=x+"px";var context=this.reflection.getContext("2d");context.clearRect(0,0,w,this.reflection.height);context.save();context.translate(0,h-1);context.scale(1,-1);context.drawImage(this.image.imgObject(),0,0,w,h);context.restore();context.save();context.globalCompositeOperation="destination-out";var gradient=context.createLinearGradient(0,0,0,this.reflectionHeight);gradient.addColorStop(1,"rgba(255, 255, 255, 1.0)");gradient.addColorStop(0,"rgba(255, 255, 255, "+(1-opacity)+")");context.fillStyle=gradient;if(navigator.appVersion.indexOf('WebKit')!=-1)
...
imageStreamEntry.didInsertThumbnailMarkupIntoDocument();};for(var i=0;i<range.length();++i)
...
{this.mJobQueue.push(job);this.p_resetTimeout(0);}
...
{this.p_resetTimeout(0);}}
IWJobQueue.prototype.p_cancelTimeout=function()
{if(this.mTimeout!=null)
{clearTimeout(this.mTimeout);this.mTimeout=null;}}
IWJobQueue.prototype.p_resetTimeout=function(delay)
{this.p_cancelTimeout();this.mTimeout=setTimeout(this.p_runQueuedJobs.bind(this),delay);}
